...
var Player = function () {
    ...
    this.handleInput = function (key) {
        switch (key){
            case 'left': this.x>0 && (this.x -= 100);break;
            case 'up': this.y>-15 && (this.y -= 85);break;
            case 'right': this.x<400 && (this.x += 100);break;
            case 'down': this.y<400 && (this.y += 85);break;
        }
    };
};
Player.prototype.render = function () {
    // 上下间隔85，从-15到400 -15, 70, 155, 240, 325, 400
    // 左右间隔100，从0到400 0, 100, 200, 300, 400
    ctx.drawImage(Resources.get(this.sprite), this.x, this.y);
};
Player.prototype.addX = function () {
    this.x += 100;
};
Player.prototype.addY = function () {
    this.y += 85;
};
